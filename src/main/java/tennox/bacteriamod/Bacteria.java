...
public class Bacteria {
    ...
    @SidedProxy(
        clientSide = "tennox.bacteriamod.BacteriaClientProxy",
        serverSide = "tennox.bacteriamod.BacteriaCommonProxy")
    ...
    public void load(FMLInitializationEvent event) {
        ...
        GameRegistry.addRecipe(
            ...
            new Object[] { "+#+", "#*#", "+-+", Character.valueOf('#'), bacteria, Character.valueOf('*'),
                Items.iron_ingot, Character.valueOf('-'), Blocks.redstone_torch, Character.valueOf('+'),
                Blocks.cobblestone });
        GameRegistry.addRecipe(
            new ItemStack(jammerItem, 1),
            new Object[] { " # ", "#*#", " - ", Character.valueOf('#'), bacteria, Character.valueOf('*'),
                Items.iron_ingot, Character.valueOf('-'), Blocks.redstone_torch });
        GameRegistry.addRecipe(
            new ItemStack(bacteria, 1),
            new Object[] { " # ", "#*#", " # ", Character.valueOf('#'), bacteriaBunch, Character.valueOf('*'),
        ...
        GameRegistry.addRecipe(
            ...
            new Object[] { "+*+", " # ", Character.valueOf('+'), Items.bread, Character.valueOf('#'),
                Items.water_bucket, Character.valueOf('*'), Blocks.sponge });
        GameRegistry.addRecipe(
            new ItemStack(Blocks.sponge, 2),
            new Object[] { "+*+", "*+*", "+#+", Character.valueOf('+'), Blocks.wool, Character.valueOf('#'),
    ...
    public void onMapMissing(FMLMissingMappingsEvent event) {
        ...
        for (MissingMapping m : list) {
            ...
            } else System.out.println("STILL MISSING: " + m.name);
        }
    }
