...
public class TileEntityBacteriaReplacer extends TileEntityBacteria {
    ...
    public void selectFood() {
        ...
        if (worldObj.isBlockIndirectlyGettingPowered(i, j, k)) {
            ...
            if (above == Blocks.air || below == Blocks.air) return;
            if (above == Bacteria.replacer || below == Bacteria.replacer) return;
    ...
    @Override
    public void die() {
        if (replace != null) worldObj.setBlock(xCoord, yCoord, zCoord, replace.block, replace.meta, 3);
